...
#translation for swedish words in the output
translations = {
    'Bostadstyp':'Housing type',
    'Upplåtelseform':'Release from',
    'Boarea': 'Living area',
    ...
    'Avgift/mån': 'Fee/month',
    'Pris/m²': 'Price/sqm',
    'Visningar': 'Viewings',
    'Mäklare': 'Broker',
    'Objektsnummer': 'Property ID',
...
class HemnetSpider(scrapy.Spider):
    ...
    def spider_closed(self, spider):
        ...
        for result in self.results.values():
            ...
            # translate attribute names to English
            english_attrs = {}
            for key, value in result['attrs'].items():
                if key in translations:
                    english_attrs[translations[key]] = value
                else:
                    english_attrs[key] = value
            result['attrs'] = english_attrs
